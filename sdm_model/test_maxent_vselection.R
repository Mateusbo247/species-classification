...
for (model in models){
	...
	for(BATCH in 1:max_batch){
		...
		output_dir <- paste0('/home/antonio/mateus_results/maxent_vselection/test_results/')
		...
		for(FOLD in 1:max_fold){
			...
			test_csv <- paste0('/home/antonio/replicacao_mateus/dataset/test_registros_species.csv')
			...
			write.csv(result_all,  paste0(path, model, '_test_fold', FOLD,'.csv'), row.names = FALSE)
		...
		write.csv(df_geral, paste0(path, model, '_test_global.csv'), row.names = FALSE)
	...
	dir.create('/home/antonio/mateus_results/maxent_vselection/test/', showWarnings = FALSE)
	write.csv(acc_mat, paste0('/home/antonio/mateus_results/maxent_vselection/test/', model, '_acc_test_results.csv'), row.names = FALSE)
	write.csv(f1s_mat, paste0('/home/antonio/mateus_results/maxent_vselection/test/', model, '_f1s_test_results.csv'), row.names = FALSE)
}
